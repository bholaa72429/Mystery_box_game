...
# stakes & starting  balance displaying
from tkinter import *
...
class Start:
    ...
    def to_game(self, stakes):
        ...
        # adding print details for starting balance and
        starting_balance_displaying = " Starting Balance: {}".format(starting_balance)
        print(starting_balance_displaying)

        # adding print details for starting balance and
        stakes_displaying = " Stakes: {}".format(stakes)
        print(stakes_displaying)
